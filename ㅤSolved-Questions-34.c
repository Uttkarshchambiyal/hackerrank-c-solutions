...
int main() {
 float n,bill,billl,billll;
    ...
    if (n>=0 &&n<=100){
        ...
        billl=(n-100)*7+500;
      if(billl<=1200){
      printf("The electricity bill is: %.2f.",billl-(billl*0.10));}
      else{
        printf("The electricity bill is: %.2f.",billl);
       }}
    else if(n>300){
        billll=(n-300)*10+1400+500;
        printf("The electricity bill is: %.2f.",billll);
    }
    else {
